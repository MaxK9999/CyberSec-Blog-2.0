...
draft: false
toc: true
tags: ["ffuf", "vhosts", "docker", "docker-escape", "PostgreSQL", "nfs", "PWM", "BloodHound", "ReadGMSAPassword", "ESC7", "certipy-ad", "ADCS"]
---
...
:::note 
However this is where I ended up in some trouble, for whatever reason `certipy-ad` didn't give me the full picture. 
Instead I used `evil-winrm-py` to login with the kerberos ticket.
:::

![alt text](<Pasted image 20251125084217.png>)

After logging in I transferred over `certify.exe` and reran my enumeration steps.

![alt text](<Pasted image 20251125084309.png>)
...
![alt text](<Pasted image 20251125091003.png>)

I starting looking through the output.

![alt text](<Pasted image 20251125091116.png>)

And down at the bottom we notice the enabled certificates:

![alt text](<Pasted image 20251125091333.png>)
...
![alt text](<Pasted image 20251125103808.png>)
...
![alt text](<Pasted image 20251125104021.png>)
...
![alt text](<Pasted image 20251125120450.png>)
...
![alt text](<Pasted image 20251125120542.png>)
...
![alt text](<Pasted image 20251125121411.png>)
...
![alt text](<Pasted image 20251125121508.png>)
...
![alt text](<Pasted image 20251125121533.png>)

This time around it worked!

![alt text](<Pasted image 20251125121556.png>)

I could now easily get access with the saved kerberos ticket:

![alt text](<Pasted image 20251125121643.png>)

#### root.txt

![alt text](<Pasted image 20251125121735.png>)

![alt text](<Pasted image 20251125121801.png>)
