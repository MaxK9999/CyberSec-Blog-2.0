...
const config: SiteConfig = {
  ...
  site: 'https://maxk9999.vercel.app/posts/imagery', 
  // The name of your site, used in the title and for SEO.
  title: 'MAXSEC',
  // The description of your site, used for SEO and RSS feed.
  description:
    'My blog about cybersecurity, programming and other things related to computer science.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Maxim Andrei Koltypin',
  // Keywords for SEO, used in the meta tags.
  tags: ['blog', 'writeups', 'hacking', 'cybersecurity', 'maxk9999', 'HTB', 'HackTheBox', 'OffSec', 'CTF', 'Proving Grounds'],
  ...
  socialLinks: {
    ...
    linkedin: 'https://www.linkedin.com/in/maxim-k-05aa0028b',
    hackthebox: 'https://app.hackthebox.com/profile/1850104',
  ...
  giscus: {
    repo: 'maxk9999/CyberSec-Blog-2.0',
    repoId: 'R_kgDOQaOVNg',
    category: 'General',
    categoryId: 'DIC_kwDOQaOVNs4CyDVJ',
